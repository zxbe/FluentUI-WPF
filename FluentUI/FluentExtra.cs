...
namespace FluentUI
{
    public static class FluentExtra
    {
        ...
        public static readonly DependencyProperty LabelProperty =
            DependencyProperty.RegisterAttached("Label", typeof(string), typeof(FluentExtra), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsRequiredProperty =
            DependencyProperty.RegisterAttached("IsRequired", typeof(bool), typeof(FluentExtra), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty ErrorMessageProperty =
            DependencyProperty.RegisterAttached("ErrorMessage", typeof(string), typeof(FluentExtra), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty PlaceholderProperty =
            DependencyProperty.RegisterAttached("Placeholder", typeof(string), typeof(FluentExtra), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CompactModeProperty =
            DependencyProperty.RegisterAttached("CompactMode", typeof(bool), typeof(FluentExtra), new PropertyMetadata(false));
